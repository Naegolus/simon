...
plt.plot(l, l,  label = "Leisure l")
plt.plot(l, l_star,  label = "Leisure l*")
plt.plot(l, e,  label = "Effort e(l)")
plt.plot(l, y,  label = "Returns y(l)")
plt.plot(l, Vi, label = "Utility Vi(l)")
plt.plot(l, Vi_star, label = "Utility Vi*(l)")
